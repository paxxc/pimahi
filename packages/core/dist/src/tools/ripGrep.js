 ...
 */
function resolveAndValidatePath(config, relativePath) {
    if (!relativePath) {
        return null;
    }
...
class GrepToolInvocation extends BaseToolInvocation {
    ...
    async performRipgrepSearch(options) {
        const { pattern, path: absolutePath, include, case_sensitive, fixed_strings, context, after, before, no_ignore, } = options;
        const rgArgs = ['--json'];
        if (!case_sensitive) {
