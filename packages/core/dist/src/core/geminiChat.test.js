...
describe('GeminiChat', () => {
    ...
    describe('sendMessageStream', () => {
        ...
        it('should throw InvalidStreamError when finishReason is MALFORMED_FUNCTION_CALL', async () => {
            ...
            const stream = await chat.sendMessageStream('test-model', { message: 'test' }, 'prompt-id-malformed');
        ...
        it('should retry when finishReason is MALFORMED_FUNCTION_CALL', async () => {
            ...
            // 2. Send a message
            const stream = await chat.sendMessageStream('test-model', { message: 'test retry' }, 'prompt-id-retry-malformed');
            const events = [];
