    ...
    action: async (context, args) => {
        ...
        if (!context.overwriteConfirmed) {
            ...
            if (exists) {
                return {
                    type: 'confirm_action',
                    prompt: React.createElement(Text, null, 'A checkpoint with the tag ', React.createElement(Text, { color: theme.text.accent }, tag), ' already exists. Do you want to overwrite it?'),
                    originalInvocation: {
